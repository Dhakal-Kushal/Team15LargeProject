  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {error && (
          <p style={{ color: '#e53e3e', fontSize: '13px', textAlign: 'center', marginBottom: '10px' }}>
            {error}
          </p>
        )}

        <label style={{ color: 'var(--text-main)', fontSize: '13px', display: 'block', marginBottom: '4px', fontWeight: 600 }}>
          Username
        </label>
        <input
          type="text"
        ...
        <label style={{ color: 'var(--text-main)', fontSize: '13px', display: 'block', marginBottom: '4px', fontWeight: 600, marginTop: '10px' }}>
          Password
        </label>
        <input
          type="password"
        ...
        <div style={{ textAlign: 'right', marginBottom: '10px' }}>
          <span
            ...
            style={{ fontSize: '12px', color: '#2d4ef5', cursor: 'pointer', textDecoration: 'underline', fontWeight: 600 }}
          >
            Forgot password?
          </span>
        </div>
        ...
        <button
          onClick={doLogin}
          style={{
            width: '100%', padding: '12px', background: '#2d4ef5',
            color: '#fff', border: 'none', borderRadius: '24px',
            cursor: 'pointer', fontWeight: 700, marginTop: '10px', fontSize: '16px'
          }}
        >
          Login
        </button>
        ...
        <p style={{ textAlign: 'center', marginTop: '20px', color: 'var(--text-sub)', fontSize: '13px' }}>
          ...
          <span
            ...
            style={{ color: '#2d4ef5', cursor: 'pointer', textDecoration: 'underline', fontWeight: 600 }}
          >
            Sign up
          </span>
        </p>
